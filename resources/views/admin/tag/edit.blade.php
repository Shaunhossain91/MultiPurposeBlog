   ...
   {{ method_field('PATCH') }}
      <div class="card-body">
         ...
         <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputPassword1" name="tag_title" placeholder="Tag Title" value="{{$tag->name}}" >
            <?php
         ...
         <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Tag Slug" name="tag_slug" value="{{$tag->slug}}">
            <?php
